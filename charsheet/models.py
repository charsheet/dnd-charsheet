...
class Character(models.Model):
    ...
    user = models.ForeignKey(GaeDatastoreUser, blank=True, null=True, related_name='user')
    users_with_access = fields.RelatedSetField(GaeDatastoreUser, blank=True, related_name='access_user')
